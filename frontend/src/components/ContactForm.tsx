      ...
      <form ref={formRef} onSubmit={handleSubmit}>
        ...
        <div className="form-fields" style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--gap-md) var(--gap-lg)' }}>
            ...
            <Field label="Phone Number" required error={errors.phone}>
              <input type="tel" name="phone" placeholder="+91 00000 00000" required style={fieldError('phone')} />
            </Field>
        ...
        {formState === 'success' && (
          <div style={{ textAlign: 'center', padding: '40px 20px' }}>
            ...
            <h4 style={{ fontSize: '18px', marginBottom: '8px' }}>Message Sent Successfully</h4>
            <p style={{ color: 'var(--muted)', fontSize: '15px', lineHeight: 1.7, maxWidth: '400px', margin: '0 auto' }}>
              We'll respond within one business day. For urgent matters, call us at +91 7874677836 or reach us on WhatsApp.
            </p>
          </div>
        )}
