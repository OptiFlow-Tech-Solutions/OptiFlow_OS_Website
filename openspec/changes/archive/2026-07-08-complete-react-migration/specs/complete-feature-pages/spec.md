...
The content in completed Features and FeatureShowcase sections SHALL match the text, headings, and structure of the corresponding sections in `src/pages/features.html` and `src/pages/feature-showcase.html`.
