...
- **AND** `--z-base` SHALL be the lowest (1)
- **AND** `--z-dropdown` SHALL be higher than base (100)
- **AND** `--z-sticky` SHALL be higher than dropdown (200)
- **AND** `--z-overlay` SHALL be higher than sticky (300)
- **AND** `--z-drawer` SHALL be higher than overlay (400)
- **AND** `--z-modal` SHALL be higher than drawer (500)
- **AND** `--z-toast` SHALL be the highest (600)
