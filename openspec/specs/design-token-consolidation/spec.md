...
Consolidate the React frontend's design tokens with the static site's `assets/css/core.css` as the single source of truth. Eliminates the forked hex-based token file in favor of Oklch color space, unified variable names, and dark mode parity.
