...
**Purpose:** Ensure the OptiFlow website builds and runs correctly as a Docker image. Covers multi-stage builds, non-root execution, healthcheck, route serving, layer caching, and pinned base image versions.
