...
React layout wrapper composing Nav, main content slot (with React Router Outlet), Footer, ScrollTop, and StickyCTA into a page shell with sticky footer behavior.
