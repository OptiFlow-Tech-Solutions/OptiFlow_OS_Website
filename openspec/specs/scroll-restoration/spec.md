...
Automatic scroll-to-top on forward navigation while preserving the browser's native scroll position restoration for back/forward navigation, requiring no per-page implementation.
