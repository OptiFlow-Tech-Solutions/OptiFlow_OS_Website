...
Booking form component — 7 input fields, honeypot spam protection, client-side validation, submission state management, and API integration with the Django backend.
