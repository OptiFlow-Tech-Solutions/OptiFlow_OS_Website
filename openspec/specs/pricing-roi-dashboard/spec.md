# pricing-roi-dashboard

## Purpose

Animated comparison bar chart on the pricing page showing traditional SaaS vs OptiFlow OS costs across 5 team sizes. Uses CSS-proportional bars with hover tooltips, connector lines, savings badges, and accessibility labels.
