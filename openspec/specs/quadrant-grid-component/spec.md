...
Reusable QuadrantGrid component for competitive positioning visualizations. Renders a 2×2 grid of competitor cards (each with label, title, weaknesses marked with ×, and advantage text) with a centered overlay circle. Responsive collapse to single column on mobile. Used by CompetitivePositioning page.
