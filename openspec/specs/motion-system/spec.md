...
CSS-driven scroll reveal animations, stagger effects, card/button hover micro-interactions, counter animations, and page transitions for the React SPA. Matches the static site's motion behavior without JavaScript animation libraries, respecting `prefers-reduced-motion`.
