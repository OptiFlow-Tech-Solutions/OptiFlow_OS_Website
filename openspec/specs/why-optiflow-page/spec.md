...
React WhyOptiFlow page migrating all 10 visual sections from the static `why-optiflow.html` into the React SPA, using shared components (Section, Card, Button, Container), hooks (useTypewriter, useMouseGlow, useCountUp, useScrollReveal), and the ComparisonTable shared component.
