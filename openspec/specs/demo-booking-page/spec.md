...
Full React page component for the demo booking conversion path — hero with dashboard mockup, benefit cards, trust bar, timeline, booking form, calendar widget, FAQ, and CTA.
