...
Configure Tailwind CSS 4 theme to map design tokens from `tokens.css` as named utility classes, enabling `text-accent`, `bg-teal`, `dark:` variant, and spacing utilities.
