...
Provide a helpful 404 error page at `/404/` that follows the site's shared error page pattern — matching the 500 page in structure, dark mode support, responsiveness, and contact information visibility. Serves users who land on missing URLs with clear navigation options and company contact details.
