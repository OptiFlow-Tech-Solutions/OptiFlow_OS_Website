...
**Purpose:** Define nginx configuration requirements for serving the OptiFlow static site. Covers HTTP compression (Brotli + Gzip), security headers, asset caching, URL redirects, health endpoint, SPA fallback, and server hardening.
