...
Custom React hooks porting all home page animations from the static home.html vanilla JavaScript to idiomatic React, with identical timing, easing, and rAF-throttling behavior.
