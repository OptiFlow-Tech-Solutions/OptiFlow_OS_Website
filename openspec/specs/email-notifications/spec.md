...
## Purpose
Standalone email notification service using Resend API for transactional emails. Handles team notifications (contact, demo, newsletter) and subscriber welcome emails with HTML templates and KV-based logging.
