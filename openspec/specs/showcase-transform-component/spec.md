# showcase-transform-component

## Purpose

Reusable ShowcaseTransform section component for the Feature Showcase page. Renders a problem block with cost pill, 2 solution cards, 3 metric cards, dual device visual (DashboardPreview + PhoneFrame), and FeatureCTA. Supports `visualSide` prop for left/right content positioning and responsive collapse.
