# design-md-structure Specification

## Purpose

Ensure the `DESIGN.md` file is a well-structured, valid markdown document — the single source of truth for the OptiFlow OS design system. All sections must be accessible as proper markdown content, not hidden inside code fences.
