...
Ensure the Plausible privacy-first analytics script is injected into every page of the OptiFlow OS marketing site via a standardized `<!-- INCLUDE: analytics -->` directive pattern, consistent with nav and footer partial injection.
