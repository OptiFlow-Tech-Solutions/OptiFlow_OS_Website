# OptiFlow OS — Enterprise DESIGN.md Specification (v5.0) — brand system
...
- **slug:** `optiflow-os-enterprise-design-md-specification-v5-0`
- **source:** designmd://optiflow-os-enterprise-design-md-specification-v
- **primary seed color:** `#1b4d81`
